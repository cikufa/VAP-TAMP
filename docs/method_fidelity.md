...
- `vlm-tamp/gpt4v.py`: REST Chat Completions, gpt-4-turbo, 256x256 input,
  max_tokens=50 for verification; unspecified temperature. Authenticated
  availability remains untested because OPENAI_API_KEY is absent.
