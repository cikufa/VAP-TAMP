...
| 2 | Connector implementation SHA | `df227f2d28576aace83d5b5b7f456efed24c0bd9`; post-freeze runtime-path and CA-trust fixes only; frozen scientific inputs remain unchanged |
